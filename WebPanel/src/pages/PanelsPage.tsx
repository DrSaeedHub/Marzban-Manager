...
import { Plus, Search, Server, MoreVertical, Pencil, Trash2, RefreshCw, ExternalLink, Loader2 } from 'lucide-react';
...
import { usePanels, useDeletePanel, useReconnectPanel } from '@/hooks/use-panels';
...
export default function PanelsPage() {
  ...
  const handleDelete = () => {
    if (deletingPanel) {
      deleteMutation.mutate(deletingPanel.id, {
        onSuccess: () => setDeletingPanel(null),
      });
    }
  };
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
                          <span className="text-muted-foreground">
                            Nodes: <span className="text-foreground font-medium">{panel.node_count}</span>
                          </span>
                          ...
                          <span className="text-muted-foreground">
                            Last sync: {panel.status === 'error' ? (
                              ...
                              <span className="text-foreground">{formatTimeAgo(panel.last_sync)}</span>
                            )}
                          </span>
                        </div>
